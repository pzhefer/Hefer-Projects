      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative" ref={projectDropdownRef}>
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors bg-white min-w-[200px] justify-between"
          >
            <span className="text-sm text-gray-700 truncate">{getProjectLabel()}</span>
            <ChevronDown size={16} className="text-gray-500 flex-shrink-0" />
          </button>

          {showProjectDropdown && (
            <div className="absolute top-full left-0 mt-1 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50 max-h-96 overflow-hidden flex flex-col">
        ...
        <div className="relative" ref={statusDropdownRef}>
          ...
          >
            <span className="text-sm text-gray-700 truncate">{getStatusLabel()}</span>
            <ChevronDown size={16} className="text-gray-500 flex-shrink-0" />
          </button>
        ...
        {(selectedProjects.length > 0 || selectedStatuses.length > 0) && (
          <div className="flex items-center space-x-2 ml-4">
            ...
            {selectedStatuses.length > 0 && (
              ...
              >
                <span>{selectedStatuses.length} Status{selectedStatuses.length > 1 ? 'es' : ''}</span>
                <X size={12} />
              </button>
            )}
          </div>
